        ...
        <div class="content-wrapper">
            ...
            <div class="px-4 pt-5 my-5 text-center">
                ...
                <div class="col-lg-6 mx-auto border-bottom border-danger pb-2 mb-4 text-start">
                    ...
                    <p class="mb-4 pb-2 text-start">Science is rarely made by one single person; LusoLit is the result of the work of several researchers. For this, we would like to thank a few people and institutions:
                        <br>
                        <br>
                ...
                <div class="col-lg-6 mx-auto mb-4 text-start">
                    <p class="mb-4 pb-2 text-start">A ciência raramente é feita por uma única pessoa; a LusoLit é o resultado do trabalho de vários investigadores. Por isso, gostaríamos de agradecer a algumas pessoas e instituições:</br>
